...
<?php 
		...
		while($p_price=mysqli_fetch_array($run_price)){
			...
			$run_qty = mysqli_query($connection, $get_qty); 
		...
		echo "<a href='https://unrent-here.000webhostapp.com/'>Go to your Account</a>";
		
		}
		else {
		
		echo "<h2>Welcome Guest, Payment was failed</h2><br>";
		echo "<a href='https://unrent-here.000webhostapp.com/'>Go to Back to shop</a>";
			...
			Hello dear <b style='color:blue;'>$c_name</b> you have ordered some products on our website onlinetuting.com, please find your order details, your order will be processed shortly. Thank you!</p>
				...
				<h2> <a href='https://unrent-here.000webhostapp.com/index.php'>Click here</a> to login to your account</h2>
